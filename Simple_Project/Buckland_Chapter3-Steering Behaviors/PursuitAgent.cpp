...
//----------------------------- ctor -------------------------------------
//------------------------------------------------------------------------
PursuitAgent::PursuitAgent(GameWorld* world,
	Vector2D position,
	double    rotation,
	Vector2D velocity,
	double    mass,
									...
									scale)
{
	...
	// lui-même pour que l'on ait ensuite qu'à changer la cible
	m_pSteering->OffsetPursuitOn(this, offset);

	// Active La force de Separation du Flocking pour garder un offset entre les diffèrents agents
...
//  
//------------------------------------------------------------------------
void PursuitAgent::Update(double time_elapsed)
{
...
// 
//------------------------------------------------------------------------
void PursuitAgent::Render()
{
	gdi->GreenPen(); // Couleur du véhicle
